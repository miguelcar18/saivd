<?php
    ...
    function guardar()
    {
        ...
        if(!is_dir("../../archivos/franquicias/".$_POST['nombre']."")) 
            mkdir("../../archivos/franquicias/".$_POST['nombre']."", 0777);
        ...
        $revision = consultaNuevo($nombre, $nivel_mod, 3);
        ...
        else
        {
            ...
            foreach ($files as $file) {
                ...
                move_uploaded_file(@$file["tmp_name"], "../../archivos/franquicias/".$_POST['nombre']."/". $nombreA);
    ...
    function limpiarFormulario()
    {
        ...
        $('form#moduloFranquiciasForm').each(function () {
            this.reset();
        });
    ...
    function editar()
    {
        ...
        //Comprobar que no este duplicado
        $revision = consultaEditar($idOriginal, $nombre, $nivel_mod, 3);
        ...
        else
        {
            ...
            rename('../../archivos/franquicias/'.$nombreAnterior,'../../archivos/franquicias/'.$nombre);
    ...
    {
        foreach(glob("../../archivos/franquicias/".$carpeta . "/*") as $archivos_carpeta)
        {
        ...
        rmdir("../../archivos/franquicias/".$carpeta);
    }