                        ...
                        <?php
                            while($row = $archivos->fetch_array())
                            {
                                ...
                                <div class="col-md-12">
                                    ...
                                    {
                                    ?>
                                        <object width="100%" height="500px" type="application/pdf" data="../../archivos/franquicias/<?= $camposModulo['nombre'].'/'.$row['nombrel']?>"></object>
                                    <?php
                                    }
                                    else if(end($separar) == 'mp4' || end($separar) == 'mov')
                                    {
                                    ?>
                                        <video  width="100%" height="auto" src="../../archivos/franquicias/<?= $camposModulo['nombre'].'/'.$row['nombrel']?>" controls></video>
                                    <?php
                                    }
                                    else if(end($separar) == 'wmv')
                                    {
                                    ?>
                                            <object data="../../archivos/franquicias/<?= $camposModulo['nombre'].'/'.$row['nombrel']?>" type="video/x-ms-wmv" width="100%" height="auto"></object>
                                    <?php
                                    }
                                    else if(end($separar) == 'jpg' || end($separar) == 'jpeg' || end($separar) == 'gif' || end($separar) == 'png' || end($separar) == 'svg')
                                    {
                                    ?>
                                        <img src="../../archivos/franquicias/<?= $camposModulo['nombre'].'/'.$row['nombrel']?>" width="100%" height="auto">
                                    <?php
                                    }
                                    ?>
                                </div>
