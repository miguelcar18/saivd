                        ...
                        <div class="col-md-12">
                            <center>
                                <fieldset id="cuerpoinicio">
                                    <p class="text-center">
                                         Responda las siguientes preguntas seleccionando la opción que usted considere correcta de acuerdo a lo estudiado. Debe contestar todas las preguntas que se presentan en la evaluación. Tiene un máximo de 3  intentos para aprobarla, sino debe realizar el  adiestramiento del módulo nuevamente. Debe acertar todas las respuestas para aprobar la evaluación. Presione el botón "Realizar Evaluación" para comenzar.
                                    </p>
                                    <a href="evaluacion-final.php?departamento=3" class="btn btn-primary" style="font-weight: bold">Realizar Evaluación</a><br><br>
                                </fieldset>
                            </center>
                        </div>
                    </div>
