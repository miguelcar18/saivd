<?php
    ...
    $pregunta6 = rand($camposLimites['minimo'], $camposLimites['maximo']);
    $pregunta7 = rand($camposLimites['minimo'], $camposLimites['maximo']);
    $pregunta8 = rand($camposLimites['minimo'], $camposLimites['maximo']);
    $pregunta9 = rand($camposLimites['minimo'], $camposLimites['maximo']);
    $pregunta10 = rand($camposLimites['minimo'], $camposLimites['maximo']);
    $consultaPreguntas= $conexion->query("SELECT * FROM preguntas WHERE idpregunta = '".$pregunta1."' OR idpregunta = '".$pregunta2."' OR idpregunta = '".$pregunta3."' OR idpregunta = '".$pregunta4."' OR idpregunta = '".$pregunta5."' OR idpregunta = '".$pregunta6."' OR idpregunta = '".$pregunta7."' OR idpregunta = '".$pregunta8."' OR idpregunta = '".$pregunta9."' OR idpregunta = '".$pregunta10."'");
?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Evaluación Final Distribución - SAIVD</title>
    </head>
    <body>
        <div id="wrapper">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h3 class="page-header-inicio">
                                <b>EVALUACIÓN FINAL - DISTRIBUCIÓN</b>
                            </h3>
                        </div>
                    </div>
                    <div class="row">
                                    ...
                                    <div class="navbar-inner">
                                        <div class="container">
                                            <ul>
                                                ...
                                                <li><a href="#tab6" data-toggle="tab">Pregunta 6</a></li>
                                                <li><a href="#tab7" data-toggle="tab">Pregunta 7</a></li>
                                                <li><a href="#tab8" data-toggle="tab">Pregunta 8</a></li>
                                                <li><a href="#tab9" data-toggle="tab">Pregunta 9</a></li>
                                                <li><a href="#tab10" data-toggle="tab">Pregunta 10</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
