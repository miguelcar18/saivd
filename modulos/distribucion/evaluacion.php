...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Evaluación Distribución - SAIVD</title>
    </head>
    <body>
        <div id="wrapper">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h3 class="page-header-inicio">
                                <b>EVALUACIÓN <?= strtoupper($camposModulo['nombre']) ?> - DISTRIBUCIÓN</b>
                            </h3>
                        </div>
                    </div>
                    <div class="row">
                                        ...
                                        <div class="tab-pane" id="tab<?= $contador ?>">
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                while($rowRespuestas = $consultaRespuestas->fetch_array())
                                                {
                                                    ...
                                                    <div class="radio">
                                                        <label>
                                                            <input name="respuesta<?= $contador ?>[]" id="respuesta<?= $contador ?>" class="respuesta<?= $contador ?>" value="<?= $rowRespuestas['idrespuesta'] ?>" type="radio" required>&nbsp;
                                                    ...
                                                    <div class="checkbox">
                                                        <label>
                                                            <input name="respuesta<?= $contador ?>[]" id="respuesta<?= $contador ?>" class="respuesta<?= $contador ?>" value="<?= $rowRespuestas['idrespuesta'] ?>" type="checkbox"required>&nbsp;
                                                            <?= $rowRespuestas['contenido'] ?>
                                                        </label>
                                                    </div>
                                                    <?php
