<?php
    ...
    function guardar()
    {
        ...
        if(!is_dir("../../archivos/mercadeo/".$_POST['nombre']."")) 
            mkdir("../../archivos/mercadeo/".$_POST['nombre']."", 0777);
        ...
        $revision = consultaNuevo($nombre, $nivel_mod, 4);
        ...
        else
        {
            ...
            foreach ($files as $file) {
                ...
                move_uploaded_file(@$file["tmp_name"], "../../archivos/mercadeo/".$_POST['nombre']."/". $nombreA);
    ...
    function limpiarFormulario()
    {
        ...
        $('form#moduloMercadeoForm').each(function () {
            this.reset();
        });
    ...
    function editar()
    {
        ...
        //Comprobar que no este duplicado
        $revision = consultaEditar($idOriginal, $nombre, $nivel_mod, 4);
        ...
        else
        {
            ...
            rename('../../archivos/mercadeo/'.$nombreAnterior,'../../archivos/mercadeo/'.$nombre);
    ...
    {
        foreach(glob("../../archivos/mercadeo/".$carpeta . "/*") as $archivos_carpeta)
        {
        ...
        rmdir("../../archivos/mercadeo/".$carpeta);
    }