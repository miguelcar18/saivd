<?php 
    ...
    $modulos= $conexion->query("SELECT * FROM modulos WHERE fkdepartamento = 4 ORDER BY nivel_mod ASC");
    if(!$modulos)
        echo $conexion->error;
?>
                                            ...
                                            while($row = $modulos->fetch_array())
                                            {
                                                ...
                                                <tr class="odd gradeX" id="fila<?=$i?>">
                                                    ...
                                                    <td>
                                                        ...
                                                        &nbsp;
                                                        <a href="" data-id="<?= $row['idmodulo'] ?>"  class="moduloMercadeoEliminar" data-fila="<?=$i?>" data-rel="tooltip" title="Eliminar <?= $row['nombre'] ?>" objeto="<?= $row['idmodulo'] ?>"> 
