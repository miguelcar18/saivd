<?php
    ...
    function guardar()
    {
        ...
        if(!is_dir("../../archivos/ventas/".$nombre."")) 
            mkdir("../../archivos/ventas/".$nombre."", 0777);
        ...
        $revision = consultaNuevo($nombre, $nivel_mod, 1);
        ...
        else
        {
            ...
            foreach ($files as $file) {
                ...
                move_uploaded_file(@$file["tmp_name"], "../../archivos/ventas/".$nombre."/". $nombreA);
    ...
    function editar()
    {
        ...
        //Comprobar que no este duplicado
        $revision = consultaEditar($idOriginal, $nombre, $nivel_mod, 1);
