<?php 
    ...
    $usuarios= $conexion->query("SELECT * FROM usuarios WHERE fkdepartamento = 4 ORDER BY usuario");
    if(!$usuarios)
        echo $conexion->error;
?>
...
<head>
    ...
    <title>Estadísticas de usuarios de Mercadeo- SAIVD</title>
</head>
<body>
    <div id="wrapper">
                                        ...
                                        <tbody>
                                            ...
                                            while($row = $usuarios->fetch_array())
                                            {
                                                ...
                                                <tr class="odd gradeX" id="fila<?=$i?>">
                                                    ...
                                                    <td><?= $row['usuario'] ?></td>
                                                    <td>
                                                        <a href="#" data-id="<?= $row['idusuario'] ?>" class="consultaMercadeo" data-rel="tooltip" title="Ver resultados de <?= $row['usuario'] ?>" style="text-decoration:none;"> 
