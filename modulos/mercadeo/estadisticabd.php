<?php
    ...
    $estadistica = $conexion->query("SELECT modulos.nombre AS modulo, estadisticas.resultado AS resultado, estadisticas.fecha AS fecha FROM estadisticas INNER JOIN modulos ON modulos.idmodulo = estadisticas.modulo WHERE usuario = ".$_POST['id']." AND departamento = 4 ORDER BY fecha ASC");
    $consultaAprobados = $conexion->query("SELECT count(resultado) AS cantidadAprobados FROM estadisticas WHERE usuario = ".$_POST['id']." AND resultado = 1 AND  departamento = 4");
    $consultaReprobados = $conexion->query("SELECT count(resultado) AS cantidadReprobados FROM estadisticas WHERE usuario = ".$_POST['id']." AND resultado = 0 AND  departamento = 4");
