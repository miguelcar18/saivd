<?php
    ...
    $adiestramiendos= $conexion->query("SELECT * FROM modulos WHERE fkdepartamento = 4 ORDER BY nivel_mod");
    if(!$adiestramientos)
        echo $conexion->error;
    if(!$adiestramiendos)
        echo $conexion->error;
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Adiestramiento Mercadeo - SAIVD</title>
    </head>
    <body>
        <div id="wrapper">
