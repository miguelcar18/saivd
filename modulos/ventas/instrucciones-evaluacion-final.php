...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Instrucciones Evaluación Ventas - SAIVD</title>
    </head>
    <body>
        <div id="wrapper">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h3 class="page-header-inicio">
                                <b>INSTRUCCIONES EVALUACIÓN FINAL - VENTAS</b>
                            </h3>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <center>
                                <fieldset id="cuerpoinicio">
                                    ...
                                    <a href="evaluacion-final.php?departamento=1" class="btn btn-primary" style="font-weight: bold">Realizar Evaluación</a><br><br>
                                </fieldset>
                            </center>
                        </div>
                    </div>
