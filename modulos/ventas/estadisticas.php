<?php
    ...
    $estadistica = $conexion->query("SELECT modulos.nombre AS modulo, estadisticas.resultado AS resultado, estadisticas.fecha AS fecha FROM estadisticas INNER JOIN modulos ON modulos.idmodulo = estadisticas.modulo WHERE departamento = 1 AND  usuario = ".$_SESSION['id_usuario']." ORDER BY fecha ASC");
