                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <p style="text-align:justify">
                                <label style="width:100px"></label><b>
                        Seleccione la "Coordinación" o "Gerencia"  que le corresponda de acuerdo a su área de trabajo para iniciar el Adiestramiento. 
                            </b></p>
                        </div>
                    </div>
                    <div class="row">
