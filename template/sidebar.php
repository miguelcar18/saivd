...
<nav class="navbar-default navbar-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav" id="main-menu">
            ...
            /*Si existe algún usuario logueado y es administrador*/ 
            ...
            if((isset($_SESSION['fkdepartamento']) && $_SESSION['fkdepartamento'] == 1 && strpos($_SERVER["REQUEST_URI"], 'distribucion/') === false && strpos($_SERVER["REQUEST_URI"], 'franquicias/') === false && strpos($_SERVER["REQUEST_URI"], 'mercadeo/') === false) || (isset($_SESSION['rol']) && $_SESSION['rol'] == 1 && strpos($_SERVER["REQUEST_URI"], 'ventas/') !== false))
            {
                ...
                <li>
                    <a href="<?= $ruta ?>modulos/ventas/estadisticas.php" <?php if($url_actual=='ventas/estadisticas.php')echo 'class="active-menu"'; ?>><i class="fa fa-pie-chart"></i> Estadística individual</a>
                </li>
                <?php if($_SESSION['rol'] != 0) {?>
                <li>
                    <a href="<?= $ruta ?>modulos/ventas/estadisticas-generales.php" <?php if($url_actual=='ventas/estadisticas-generales.php')echo 'class="active-menu"'; ?>><i class="fa fa-pie-chart"></i> Estadísticas generales</a>
                </li>
                <li>
            ...
            if((isset($_SESSION['fkdepartamento']) && $_SESSION['fkdepartamento'] == 2 && strpos($_SERVER["REQUEST_URI"], 'ventas/') === false && strpos($_SERVER["REQUEST_URI"], 'franquicias/') === false && strpos($_SERVER["REQUEST_URI"], 'mercadeo/') === false) || (isset($_SESSION['rol']) && $_SESSION['rol'] == 1 && strpos($_SERVER["REQUEST_URI"], 'distribucion/') !== false))
            {
                ...
                <li>
                    <a href="<?= $ruta ?>modulos/distribucion/estadisticas.php" <?php if($url_actual=='distribucion/estadisticas.php')echo 'class="active-menu"'; ?>><i class="fa fa-pie-chart"></i> Estadística individual</a>
                </li>
                <?php if($_SESSION['rol'] != 0) {?>
                <li>
                    <a href="<?= $ruta ?>modulos/distribucion/estadisticas-generales.php" <?php if($url_actual=='distribucion/estadisticas-generales.php')echo 'class="active-menu"'; ?>><i class="fa fa-pie-chart"></i> Estadísticas Generales</a>
                </li>
                <li>
            ...
            if((isset($_SESSION['fkdepartamento']) && $_SESSION['fkdepartamento'] == 3 && strpos($_SERVER["REQUEST_URI"], 'ventas/') === false && strpos($_SERVER["REQUEST_URI"], 'distribucion/') === false && strpos($_SERVER["REQUEST_URI"], 'mercadeo/') === false) || (isset($_SESSION['rol']) && $_SESSION['rol'] == 1 && strpos($_SERVER["REQUEST_URI"], 'franquicias/') !== false))
            {
                ...
                <li>
                    <a href="<?= $ruta ?>modulos/franquicias/estadisticas.php" <?php if($url_actual=='franquicias/estadisticas.php')echo 'class="active-menu"'; ?>><i class="fa fa-pie-chart"></i> Estadística individual</a>
                </li>
                <?php if($_SESSION['rol'] != 0) {?>
                <li>
                    <a href="<?= $ruta ?>modulos/franquicias/estadisticas-generales.php" <?php if($url_actual=='franquicias/estadisticas-generales.php')echo 'class="active-menu"'; ?>><i class="fa fa-pie-chart"></i> Estadísticas de analistas</a>
                </li>
                <li>
            ...
            if((isset($_SESSION['fkdepartamento']) && $_SESSION['fkdepartamento'] == 4 && strpos($_SERVER["REQUEST_URI"], 'ventas/') === false && strpos($_SERVER["REQUEST_URI"], 'distribucion/') === false && strpos($_SERVER["REQUEST_URI"], 'franquicias/') === false) || (isset($_SESSION['rol']) && $_SESSION['rol'] == 1 && strpos($_SERVER["REQUEST_URI"], 'mercadeo/') !== false))
            {
                ...
                <li>
                    <a href="<?= $ruta ?>modulos/mercadeo/estadisticas.php" <?php if($url_actual=='mercadeo/estadisticas.php')echo 'class="active-menu"'; ?>><i class="fa fa-pie-chart"></i> Estadística individual</a>
                </li>
                <?php if($_SESSION['rol'] != 0) {?>
                <li>
                    <a href="<?= $ruta ?>modulos/mercadeo/estadisticas-generales.php" <?php if($url_actual=='mercadeo/estadisticas-generales.php')echo 'class="active-menu"'; ?>><i class="fa fa-pie-chart"></i> Estadísticas de analistas</a>
                </li>
                <li>
